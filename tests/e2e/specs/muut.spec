...
### Muutokset vankilaopetus

* Avaa ExpandableRow "muut_04"
* Lomakeoperaatio "Vankilaopetus" valitse "Koulutuksen järjestäjän tulee toimia yhteistyössä muiden vankilaopetusta järjestävien ammatillisen koulutuksen järjestäjien kanssa."
* Lomakeoperaatio "Vankilaopetus" valitse "Koulutuksen järjestäjällä on oikeus järjestää kohdassa 1 mainittuja tutkinto- ja valmentavaa koulutusta vankilaopetuksena."

### Perustelut vankilaopetus

* Seuraava sivu
* Assert if text exists "Koulutuksen järjestäjän tulee toimia yhteistyössä muiden vankilaopetusta järjestävien ammatillisen koulutuksen järjestäjien kanssa."
* Assert if text exists "Koulutuksen järjestäjällä on oikeus järjestää kohdassa 1 mainittuja tutkinto- ja valmentavaa koulutusta vankilaopetuksena."
