...
const contentFi = (
  <div className="mx-auto w-full sm:w-3/4 mb-16">
    <h1 className="mb-2 mt-2">Saavutettavuusseloste</h1>
    <p className="mb-2">
    ...
    <h2 className="mb-2">Digipalvelun saavutettavuuden tila</h2>
    <p className="mb-2">Täyttää saavutettavuusvaatimukset osittain.</p>
    <h2 className="mb-2">
      Digipalvelun ei-saavutettava sisältö (WCAG-kriteerien mukaan)
    </h2>
    <h3 className="mb-2">Havaittava</h3>
    <h4 className="mb-2">Saavutettava sisältö ja sen puutteet</h4>
    <h4 className="mb-2" style={{ "font-weight": "normal" }}>
      OIVA-palvelun portaalin havaittavuus
    </h4>

    <h4 className="mb-2">Saavutettavuusvaatimukset jotka eivät täyty</h4>
    <p className="mb-2">
    ...
    <h3 className="mb-2">Hallittava</h3>
    <h4 className="mb-2">Saavuttamaton sisältö ja sen puutteet</h4>
    <h4 className="mb-2" style={{ "font-weight": "normal" }}>
    ...
    <h3 className="mb-2">Ymmärrettävä</h3>
    <h4 className="mb-2">Saavuttamaton sisältö ja sen puutteet</h4>
    <h4 className="mb-2" style={{ "font-weight": "normal" }}>
      OIVA-palvelun portaalin hallittavuus
    </h4>
    ...
    <h3 className="mb-2">Toimintavarma</h3>
    <h4 className="mb-2">Saavuttamaton sisältö ja sen puutteet</h4>
    <h4 className="mb-2" style={{ "font-weight": "normal" }}>
      OIVA-palvelun portaalin hallittavuus
    </h4>
    ...
    <h3 className="mb-2">Sähköpostilla</h3>
    <p className="mb-2">
    ...
    <h2 className="mb-2">Valvontaviranomainen</h2>
    <p className="mb-2">
    ...
    <h2 className="mb-2">Valvontaviranomaisen yhteystiedot</h2>
    <p className="mb-2">
