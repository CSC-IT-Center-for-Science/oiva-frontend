...
const ContentFi = (
  <div className="mx-auto w-full sm:w-3/4 mb-16">
    <h1 className="mb-2">Yhteydenotto</h1>
    <h2 className="mb-2">Kysy tai anna palautetta</h2>
    <p className="mb-2">
    ...
    <h2 className="mb-2">Opetus- ja kulttuuriministeriön yhteystiedot</h2>
    <p className="mb-2">
      <a
...
const ContentSv = (
  <div className="mx-auto w-full sm:w-3/4 mb-16">
    <h1 className="mb-2">Kontaktuppgifter</h1>
    <h2 className="mb-2">Fråga eller ge response</h2>
    <p className="mb-2">
